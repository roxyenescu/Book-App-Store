...
const DialogueHeavyDramas = () => {
    const [Data, setData] = useState([]);

    useEffect(() => {
        const fetch = async () => {
            const response = await axios.get(
                'http://localhost:1000/api/v1/dialogue-heavy-dramas'
            );
    ...
    return (
        <div className="mt-8 px-4">
            <h4 className="text-3xl text-yellow-100">Dialogue-Heavy Dramas</h4>
...
export default DialogueHeavyDramas;
